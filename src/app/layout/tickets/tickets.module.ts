...
@NgModule({
  declarations: [TicketsComponent, DyTicketTableComponent, ViewTicketComponent, CreateTicketComponent, ViewTicketExtraListsComponent, ViewAttachmentComponent, ViewTicketDataComponent],
  imports: [
    CommonModule,
